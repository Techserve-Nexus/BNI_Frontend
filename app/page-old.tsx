          ...
          <div className="mb-8 grid gap-8 md:grid-cols-4">
            <div>
              <div className="mb-4 flex items-center gap-2">
                <span className="text-2xl">🤝</span>
                <span className="text-bni-white text-xl font-bold">BNI</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li>
                  <Link href="#vision" className="text-white transition">
                    Our Vision
                  </Link>
                </li>
                <li>
                  <Link href="#events" className="text-white transition">
                    Events
                  </Link>
                </li>
                <li>
                  <Link href="/membership" className="text-white transition">
                    Membership
                  </Link>
                </li>
                <li>
                  <Link href="/calendar" className="text-white transition">
                    Calendar
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h4 className="mb-4 font-bold text-white">Connect With Us</h4>
