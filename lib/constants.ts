...
export const BRAND = {
  ...
  coreValues: [
    { id: 1, name: 'Givers Gain®', emoji: '🤝', description: 'By giving business to others, you will get business in return' },
    { id: 2, name: 'Building Relationships', emoji: '💼', description: 'Strong relationships are the foundation of successful networking' },
    { id: 3, name: 'Lifelong Learning', emoji: '📚', description: 'Continuous growth and education for personal and professional development' },
    { id: 4, name: 'Innovation', emoji: '✨', description: 'Embracing change and finding new ways to create value' },
    { id: 5, name: 'Positive Attitude', emoji: '⚡', description: 'Maintaining optimism and enthusiasm in all interactions' },
    { id: 6, name: 'Accountability', emoji: '🎯', description: 'Taking responsibility for our commitments and actions' },
    { id: 7, name: 'Recognition', emoji: '🏆', description: 'Celebrating achievements and acknowledging contributions' },
